...
public class RocketMQCanalConnector implements CanalMQConnector {
    ...
    public RocketMQCanalConnector(String nameServer, String topic, String groupName, boolean flatMessage,Integer retryTimes,boolean vipChannelEnabled){
    ...
    public void connect() throws CanalClientException {
        ...
        rocketMQConsumer.setConsumerGroup(this.groupName);
        rocketMQConsumer.setNamesrvAddr(this.nameServer);
        rocketMQConsumer.setVipChannelEnabled(this.vipChannelEnabled);
    }
    @Override
    ...
    private boolean process(List<MessageExt> messageExts) {
        ...
        for (MessageExt messageExt : messageExts) {
            ...
            if(reconsumeTimes>retryTimes){
                //超过最大重试次数
                logger.warn("Reconsume more than "+retryTimes+" times");
                return true;
            }
            try {
                if (!flatMessage) {
    ...
    private static boolean isFirstSub = false;

    private static long startTime = System.currentTimeMillis();

    private static boolean enableHisConsumer = false;
