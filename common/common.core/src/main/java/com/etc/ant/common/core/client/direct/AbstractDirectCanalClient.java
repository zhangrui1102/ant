 ...
 * @since JDK1.8
 **/
public abstract class AbstractDirectCanalClient extends AbstractCanalClient {

    protected final static Logger logger             = LoggerFactory.getLogger(AbstractDirectCanalClient.class);
    ...
    public AbstractDirectCanalClient(String destination){
        this(destination, null,null);
    }

    public AbstractDirectCanalClient(String destination, Integer batchSize){
        this(destination,null,batchSize);
    }

    public AbstractDirectCanalClient(String destination, CanalConnector connector){
        this(destination,connector,null);
    }

    public AbstractDirectCanalClient(String destination, CanalConnector connector, Integer batchSize){
    ...
    public void start() {
        ...
        running = true;
        thread.start();
        logger.info("canal connector start..");
    }
