...
import com.etc.ant.common.database.client.AbstractDbClient;
import com.etc.ant.common.database.dialect.DbDialect;
import com.etc.ant.common.database.dialect.SqlTemplate;
import com.etc.ant.common.database.dialect.mysql.MysqlDialect;
import com.etc.ant.common.database.dialect.mysql.MysqlSqlTemplate;
import com.etc.ant.common.database.utils.SqlUtils;
...
public abstract class AbstractMysqlClient extends AbstractDbClient {
    ...
    protected void executeDDL(String sql) {
        dbDialect.getJdbcTemplate().execute(sql);
    }
