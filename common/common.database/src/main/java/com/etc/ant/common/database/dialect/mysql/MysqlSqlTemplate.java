...
package com.etc.ant.common.database.dialect.mysql;

import com.etc.ant.common.database.dialect.AbstractSqlTemplate;
...
public class MysqlSqlTemplate extends AbstractSqlTemplate {
    ...
    public String getMergeSql(String schemaName, String tableName, String[] pkNames, String[] columnNames,
        ...
        if (includePks) {
            // db merge sql匹配了uniqe / primary key时都会执行update，所以需要更新pk信息
            size = pkNames.length;
            for (int i = 0; i < size; i++) {
